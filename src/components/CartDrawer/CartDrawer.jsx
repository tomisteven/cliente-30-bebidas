                        ...
                        <div className={styles.itemsList}>
                            {cart.length === 0 ? (
                                ...
                                cart.map((item) => {
                                    ...
                                    const imageUrl = Array.isArray(imagenes) && imagenes.length > 0
                                        ? imagenes[0]
                                    ...
                                    const itemKey = `${item._id}-${item.type}-${item.unitType || 'unit'}`;
                                    ...
                                    return (
                                        <div key={itemKey} className={styles.cartItem}>
                                            ...
                                            <div className={styles.itemInfo}>
                                                ...
                                                <p className={styles.itemSize}>Tipo: {unitLabels[item.unitType || 'unit']}</p>
                                                <p className={styles.itemPrice}>
                                                    {formatCurrency(convertToARS(getItemPrice(item)))}
                                                </p>
                                                <div className={styles.itemActions}>
                                                    <div className={styles.qtyBtn} onClick={() => updateQuantity(item._id, item.type, item.quantity - 1, item.unitType)}>
                                                        <FiMinus />
                                                    </div>
                                                    ...
                                                    <button
                                                        ...
                                                        onClick={() => removeFromCart(item._id, item.type, item.unitType)}
                                                    >
                                                        <FiTrash2 />
                                                    </button>
                                                </div>
                            ...
                            <div className={styles.footer}>
                                ...
                                {!isAuthenticated && (
                                    <p className={styles.loyaltyTip}>
                                        <FiAlertCircle /> <span>Regístrate para acumular puntos Oud.</span>
                                    </p>
                                )}
                            </div>
                        )}
