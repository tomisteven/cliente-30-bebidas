                ...
                <div className={styles.overlay}>
                    ...
                    >
                        ...
                        <div className={styles.content}>
                            ...
                            <h2 className={styles.title}>10% OFF EN TU PRIMERA COMPRA</h2>
                            <p className={styles.description}>
                                Únete a nuestra selecta comunidad y recibe un cupón exclusivo directo en tu correo.
                            </p>
                            ...
                            <p className={styles.footerText}>
                                No enviamos spam. Solo elegancia.
                            </p>
                        </div>
                    </motion.div>
                </div>
